...
migration-test:
	...
	uv run pytest tests/integration/test_identity_migrations.py tests/integration/test_workflow_definition_migrations.py tests/integration/test_workflow_run_migrations.py tests/integration/test_task_dispatch_migrations.py
...
workflow-persistence-test:
	...
	uv run pytest tests/integration/test_workflow_persistence.py tests/integration/test_workflow_version_resolution.py tests/integration/test_workflow_run_creation.py tests/integration/test_workflow_run_idempotency.py
