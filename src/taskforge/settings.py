...
class Settings(BaseSettings):
    ...
    rate_limit_fallback_capacity: int = Field(default=10_000, ge=100, le=100_000)
    rate_limit_cleanup_retention_seconds: int = Field(default=3600, ge=600, le=86400)
    api_auth_network_failures_per_minute: int = Field(default=30, ge=1)
    api_auth_credential_failures_per_five_minutes: int = Field(default=10, ge=1)
    worker_auth_network_failures_per_minute: int = Field(default=30, ge=1)
    worker_auth_credential_failures_per_five_minutes: int = Field(default=10, ge=1)
    run_creations_per_minute: int = Field(default=60, ge=1)
    run_replays_per_minute: int = Field(default=12, ge=1)
    dead_letter_redrives_per_minute: int = Field(default=6, ge=1)
    worker_registrations_per_minute: int = Field(default=10, ge=1)
    worker_results_per_minute: int = Field(default=1200, ge=1)
